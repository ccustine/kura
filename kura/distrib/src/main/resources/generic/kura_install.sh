...
#set up Kura init
sed "s|INSTALL_DIR|${INSTALL_DIR}|" ${INSTALL_DIR}/kura/install/kura.service.edison > /lib/systemd/system/kura.service
...
#cp ${INSTALL_DIR}/kura/install/network.interfaces.rhel /etc/network/interfaces
#cp ${INSTALL_DIR}/kura/install/network.interfaces.rhel ${INSTALL_DIR}/kura/.data/interfaces
